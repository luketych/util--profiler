...
export default async function profileImport(modulePath, importMetaUrl, _importer = null, _marker = null) {
    ...
    const durationNs = endTime - start; // Duration in nanoseconds (BigInt)
    const time = Number(durationNs) / 1e6; // Individual time in ms (float)
    ...
    cumulativeImportTimeNs += durationNs; // Add nanoseconds directly
